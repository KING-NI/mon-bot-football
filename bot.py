...
# ------------------------------------------------------------
# 4. FONCTIONS BZZOIRO (avec cache pour les ligues)
# ------------------------------------------------------------
_league_cache = None
_league_cache_time = None

def get_all_leagues():
    """Récupère toutes les ligues disponibles depuis Bzzoiro."""
            ...
            for odd in bm.get('odds', []):
                ...
                if market_type == "1x2":
                    ...
                    if prob_home > prob_away and prob_home > prob_draw:
                        ...
                        pred = "🤝 Nul"
                    # Interface améliorée : barres de progression
...
def menu_ligues_inline(lang="fr"):
    ...
    if not leagues:
        # Fallback : quelques ligues connues
        ...
        for league in leagues[:20]:  # Limiter à 20 pour éviter le spam
